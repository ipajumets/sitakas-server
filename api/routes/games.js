...
router.post("/get-game-data", roomsController.get_room_data, usersController.check_if_player, controller.get_game, roundsController.get_round, handsController.get_hand, cardsController.get_my_cards);
